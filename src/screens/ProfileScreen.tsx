        ...
        <Layout no_padding_top>
            ...
            >
                ...
                >
                    ...
                    />
                    <Text marginVertical='s' variant='body2' opacity={.7}>{current_user?.full_name}</Text>
                    <Text variant='description' opacity={.7}>{current_user?.job_title}</Text>
                </Box>
                <Box
                    marginHorizontal="m"
                    marginBottom="s"
                ...
                >
                    ...
                    >
                        <Text marginBottom="m" variant="body2" opacity={0.7}>
                            Main Info
                        </Text>
                ...
                >
                    ...
                    <Text variant="description">{current_user?.about}</Text>
                </Box>
                <Box
                    marginHorizontal="m"
                    marginBottom="s"
                ...
                >
                    ...
                    >
                        ...
                        <Box marginLeft="s" flexGrow={1}>
                            <Text variant="body2" opacity={0.7}>
                                {current_user?.education.university_name}
                            </Text>
                            <Box
                                flexDirection="row"
                                alignItems="center"
                            ...
                            >
                                <Text variant="small" opacity={0.7}>
                                    {current_user?.education.degree_name}
                                </Text>
                                <Text variant="small" opacity={0.7}>
                                    {current_user?.education.duration}
                                </Text>
                            </Box>
                        </Box>
                    </Box>
